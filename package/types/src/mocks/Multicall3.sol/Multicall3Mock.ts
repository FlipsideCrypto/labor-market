...
export declare namespace Multicall3Mock {
...
export interface Multicall3MockInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    ...
    values: [Multicall3Mock.CallStruct[]]
  ): string;
  encodeFunctionData(
    functionFragment: "aggregate3",
    values: [Multicall3Mock.Call3Struct[]]
  ): string;
  encodeFunctionData(
    functionFragment: "aggregate3Value",
    values: [Multicall3Mock.Call3ValueStruct[]]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [PromiseOrValue<boolean>, Multicall3Mock.CallStruct[]]
  ): string;
  encodeFunctionData(
...
export interface Multicall3Mock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Multicall3MockInterface;
  ...
  functions: {
    aggregate(
      calls: Multicall3Mock.CallStruct[],
      overrides?: PayableOverrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;

    aggregate3(
      calls: Multicall3Mock.Call3Struct[],
      overrides?: PayableOverrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;

    aggregate3Value(
      calls: Multicall3Mock.Call3ValueStruct[],
      overrides?: PayableOverrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    aggregate3(
      calls: Multicall3Mock.Call3Struct[],
      overrides?: CallOverrides
    ): Promise<Multicall3Mock.ResultStructOutput[]>;
    ...
    blockAndAggregate(
      ...
      [BigNumber, string, Multicall3Mock.ResultStructOutput[]] & {
        blockNumber: BigNumber;
        blockHash: string;
        returnData: Multicall3Mock.ResultStructOutput[];
      }
    >;

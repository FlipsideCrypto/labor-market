...
export interface NBadgeAuthorityInterfaceInterface extends utils.Interface {
  functions: {
...
export interface NBadgeAuthorityInterface extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NBadgeAuthorityInterfaceInterface;
